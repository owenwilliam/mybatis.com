...
public interface TutorMapper
{
	...
	@Results({
			...
			@Result(property = "address", column = "addr_id", one = @One(select = "com.owen.mybatis.mappers.AddressMapper.selectAddressById")),
			@Result(property = "courses", column = "tutor_id", many = @Many(select = "com.owen.mybatis.mappers.TutorMapper.selectCoursesByTutorId")) })
	...
	Tutor findTutorByNameAndEmail(@Param("name") String name,
